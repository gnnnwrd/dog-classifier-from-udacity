...
# obtain ImageNet labels IM USING PATH
#with open("D:\\learning_zone\\Latihan Udacity_AI with Python\\AIPND-revision-master\\intropyproject-classify-pet-images\\imagenet1000_clsid_to_human.txt") as imagenet_classes_file:
#    imagenet_classes_dict = ast.literal_eval(imagenet_classes_file.read())
# Membuat path lengkap ke file imagenet1000_clsid_to_human.txt
